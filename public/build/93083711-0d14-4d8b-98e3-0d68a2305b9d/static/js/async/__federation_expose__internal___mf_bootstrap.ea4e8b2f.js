/*! For license information please see __federation_expose__internal___mf_bootstrap.ea4e8b2f.js.LICENSE.txt */
"use strict";(self["chunk_pimcore_studio_ui_bundle "]=self["chunk_pimcore_studio_ui_bundle "]||[]).push([["2108"],{60656(e,t,i){i.r(t),i.d(t,{PimcoreStudio:()=>h,Pimcore:()=>s});var a=i(63364),n=i(92812),r=i(88358),m=i(56797),o=i(25085);let d=new class{getTranslationResources(){let e={};return(r.A.languages??[]).forEach(t=>{let i=r.A.getResourceBundle(t,"translation");(0,m.isNil)(i)||(e[t]=i)}),e}getCurrentLanguage(){return r.A.language}getFallbackLanguage(){let e=r.A.options.fallbackLng;if(Array.isArray(e))return e[0]??"en";if((0,o.isNonEmptyString)(e))return e;if((0,m.isPlainObject)(e)){var t;return(null==(t=e.default)?void 0:t[0])??"en"}return"en"}reportMissingTranslation(e){r.A.emit("missingKey",[r.A.language],"translation",e,e)}};var g=i(57259),p=i(81607),l=i(70463);let s={container:a.kL},h={document:n.I,i18n:d,element:g.h,modal:p.Y,settings:l.a}},81607(e,t,i){i.d(t,{Y:()=>r});var a=i(56797);let n=null,r=new class{setModalInstance(e){n=e}getModalInstance(){if((0,a.isNull)(n))throw Error("Modal instance not initialized. Make sure App.useApp() is called in the parent window.");return n}constructor(){this.info=e=>this.getModalInstance().info(e),this.success=e=>this.getModalInstance().success(e),this.error=e=>this.getModalInstance().error(e),this.warning=e=>this.getModalInstance().warning(e),this.confirm=e=>this.getModalInstance().confirm(e)}}},70463(e,t,i){i.d(t,{a:()=>n});var a=i(72098);let n=new class{initialize(e){this.store=e}getSettings(){if(null===this.store)return console.warn("Settings API not initialized - Redux store not available"),null;try{return(0,a.mt)(this.store.getState())}catch(e){return console.error("Failed to get settings from store:",e),null}}areSettingsAvailable(){return null!==this.store&&null!==(0,a.mt)(this.store.getState())}constructor(){this.store=null}}},55831(e,t,i){i.a(e,async function(a,n){try{i.r(t),i(30820);var r=i(99924),m=i(80323),o=i(60656),d=i(27755);e=i.hmd(e),void 0!==e.hot&&e.hot.accept(),window.Pimcore=(await Promise.resolve().then(i.bind(i,60656))).Pimcore,window.PimcoreStudio=o.PimcoreStudio,window.addEventListener("load",async()=>{await m.f.loadPlugins(),m.f.initPlugins(),m.f.startupPlugins(),d.s.initModules(),(0,r.T)()}),n()}catch(e){n(e)}},1)},99924(e,t,i){i.d(t,{T:()=>H});var a=i(74848),n=i(41990),r=i(5338),m=i(64471),o=i(34978),d=i(31427),g=i(16665),p=i(56797),l=i(41630),s=i(39154),h=i(77885),x=i(46236);let c=(0,x.createGlobalStyle)`
  * {
